  ...
  schemas: {
    ...
    crudedrugSchema: Joi.object().keys({
      ...
      name_en: Joi.string()
        .allow("")
        .optional(),
      name_loc1: Joi.string()
        .allow("")
        .optional(),
      name_loc2: Joi.string()
        .allow("")
        .optional(),
      gname: Joi.string()
        .allow("")
    ...
    herbsmedSchema: Joi.object().keys({
      ...
      idtype: Joi.string()
        .allow("")
        .optional(),
      refDclass: Joi.string()
        .allow("")
        .optional(),
      refCompany: Joi.string()
        .allow("")
        .optional(),
      refCrude: Joi.array()
        .allow("")
        .optional(),
      refMedtype: Joi.array()
        .allow("")
        .optional()
    }),
    ...
    plantethnicSchema: Joi.object().keys({
      ...
      disease_ing: Joi.string()
        .allow("")
        .optional(),
      section_ina: Joi.string().required(),
      section_ing: Joi.string()
        .allow("")
        .optional(),
      family: Joi.string().required(),
      refEthnic: Joi.string()
        .allow("")
        .optional(),
      refPlant: Joi.string()
        .allow("")
        .optional(),
      refCrudedrug: Joi.string()
        .allow("")
        .optional(),
      refProvince: Joi.string()
        .allow("")
        .optional()
    }),
    ...
    compoundSchema: Joi.object().keys({
      compound_id: Joi.string()
        .allow("")
        .optional(),
      cname: Joi.string()
        .allow("")
        .optional(),
      effect_compound: Joi.string()
        .allow("")
        .optional(),
      pubchem_ID: Joi.string()
        .allow("")
        .optional(),
      knapsack_ID: Joi.string()
        .allow("")
        .optional(),
      chemspider_ID: Joi.string()
        .allow("")
        .optional(),
      other_ID: Joi.string()
        .allow("")
      ...
      note: Joi.string()
        .allow("")
        .optional(),
      ref_effect: Joi.string()
        .allow("")
        .optional(),
      refCrudeCompound: Joi.array()
        .allow([])
        .optional(),
      refPlant: Joi.array()
        .allow([])
